...
public class PrefsGibbs extends Gibbs {
	 ...
	 * 
	 * @param subst
	 *            : The parameter in which the subsitute values are written
	 * @param vals
	 *            : Values to be used, i.e. features
	 * @param var
	 *            : Variable that has to be substituted
	 */
	 ...
	 * 
	 * @param xadd
	 *            : xadd to be replaced in
	 * @param vals
	 *            : preference values ... user, item1, item2 values
	 * @return
	 */
