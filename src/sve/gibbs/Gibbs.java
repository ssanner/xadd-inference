...
public abstract class Gibbs {
	 ...
	 * 
	 * @param filename
	 *            : Name of the file containing the graphical model for the
	 *            prior
	 * @param utilitpath
	 *            : Path to the file containing the definition of the utility
	 *            function
	 * @param ds
	 *            : Dataset of the preferences contaning items, users,
	 *            preferences. Prefrences contains user|item1|item2 meaning that
	 *            item1 is prefered to item2 for the user
	 * @param evaluate_exact
	 *            : If the results are needed to be compared to the exact
	 ...
	 * 
	 * @param num
	 *            : numerator of the CDF
	 * @param denom
	 *            : Denominator for the CDF
	 */
