...
//        Polynomial bPolynomial1 = factory.makePolynomial(Double.toString(B1));
        ...
        ConstrainedPolynomial nStatement1 = new ConstrainedPolynomial(factory.makePolynomial(Double.toString(1.0 - B1 - S1)), Arrays.asList(sConstraint1, bConstraint1));
        ...
        ConstrainedPolynomial nStatement5 = new ConstrainedPolynomial(factory.makePolynomial(Double.toString(1.0 - S3 - B3)), Arrays.asList(sConstraint3, bConstraint3));

        //if S1, B3: 1-f(S1)-f(B3)
        ConstrainedPolynomial nStatement6 = new ConstrainedPolynomial(factory.makePolynomial(Double.toString(1.0 - S1 - B3)), Arrays.asList(sConstraint1, bConstraint3));
