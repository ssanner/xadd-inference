...
%    \begin{subfigure}[b]{0.4\textwidth}    
%        %        \centering
%        \includegraphics[width=\linewidth, height=0.8\linewidth]{images/opt_execution_i_w1}
%        \caption{$ w_1 \in \left[ 0.0, 100.0 \right]$}
%        \label{fig:opt_execution_w1}
%        \vspace{1em}
%    \end{subfigure}
...
%        \label{fig:pt_execution_w2}
%    \end{subfigure}  
%    \caption{Optimal Execution. $ inventory \in \left[ 0.0, 50.0 \right]$ is on the x-axis and $ w_1 \in \left[ 0.0, 2.0 \right]$ is on the y-axis. $ price_0 = 10.0, price = 100.0$.}
%    \label{fig:pt_execution}
%\end{figure}
%------------------------------------------------------------------------------