...
public class RoverGenLinear {
    ...
    public final static String PATH_FILES = "/home/karina/XADD/xadd-inference/src/cmdp/ex/RoverLinearProblems/";
    ...
    public void GenRoverFile(int size) {
        ...
        String filename = PATH_FILES + "roverLinear" + size + ".cmdp";
        PrintWriter os = null;
        try {
                        ...
                        while (it4.hasNext()) {
                            ...
                            if (idVar4.equals(idVar2) == false && idVar4.equals(idVar3) == false) {
                                ...
                                if (idVar4.equals(idVar2) == true) {
                                    os.println(idVar4 + "' ([energy> " + _df.format(totalenergy) + " + 0.0002 * time]");
                                    os.println("   ([0.0])");
                                    os.println("   (" + idVar4);
                                    os.println("       ([1.0])");
                                    os.println("       ([0.0])");
...
//							taken does not change
                        ...
                        os.println("time' ([energy>" + _df.format(totalenergy) + " + 0.0002 * time]");
                        os.println(" (" + idVar2);
                        ...
                        os.println(" ([time]) ");
                        os.println(")");
                        os.println("energy' ([energy>" + _df.format(totalenergy) + " + 0.0002 * time]");
                        os.println(" (" + idVar2);
            ...
            while (it6.hasNext()) {
                ...
                //print time and energy
                os.println("time' ([energy>3  + 0.0002 * time]");
                os.println(" (" + idVar6);
                os.println("   ([time > 36000]");
                os.println("     ([time < 50400]");
                ...
                os.println(" ([time])");
                os.println(")");
                os.println("energy' ([energy>3  + 0.0002 * time]");
                os.println(" (" + idVar6);
                os.println("   ([time > 36000]");
                os.println("     ([time < 50400]");
                //os.println( "       (taken"+ idVar6);
                ...
                os.println("reward ([energy>3  + 0.0002 * time]");
                os.println(" (" + idVar6);
                os.println("   ([time > 36000]");
                os.println("     ([time < 50400]");
                //os.println( "       (taken"+ idVar6);
    ...
    public static void main(String[] args) {
        RoverGenLinear tg = new RoverGenLinear();
        tg.GenRoverFile(2);
