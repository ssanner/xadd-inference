 ...
 * Time: 8:36 PM
 */
public class PolyPreferenceLearning {
    /*
    Prior weight of Ws is considered uniform in [-C, C]
     */
    public static double C = 10.0; //todo range of uniform distributions should be decided in a more flexible way.
...
//    private double epsilon;
    ...
    public PolyPreferenceLearning(PreferenceDatabase db, double indicatorNoise, String weightVectorName) {
...
//        System.out.println("itemUtilStr = " + itemUtilStr);
    ...
    public hgm.poly.pref.GatedPolytopesHandler computePosteriorWeightVector(int maxGatingConditionViolation){
    return computePrefPosteriorWeightVector(db.getPreferenceResponses(), maxGatingConditionViolation);
    }

    //Pr(W | R^n)
    private hgm.poly.pref.GatedPolytopesHandler computePrefPosteriorWeightVector(List<Preference> preferenceResponses,
...
//        XADD.XADDNode[] pWeights = new XADD.XADDNode[numAttribs];
        ...
        GatedPolytopesHandler gatedPolytopes = new GatedPolytopesHandler(factory, prior, indicatorNoise, maxGatingConditionViolation);
