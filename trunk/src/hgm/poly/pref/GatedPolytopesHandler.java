 ...
 * Time: 5:05 PM
 */
public class GatedPolytopesHandler implements Function {
    ...
    public GatedPolytopesHandler(PolynomialFactory factory, ConstrainedPolynomial prior, double indicatorNoise, int maxAllowedGatingViolations) {
...
//    }
    ...
    public List<Boolean> adjustedGateActivationMask(Double[] assignment) {
        for (int i = 0; i < posGatingConstraints.size(); i++) {
