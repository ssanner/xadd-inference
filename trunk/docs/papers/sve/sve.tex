...
\begin{center}
\begin{tabular}{ccc}
\hspace{-3mm} \includegraphics[width=120pt]{radar_x_2_fix.pdf} & \hspace{-5mm} \includegraphics[width=120pt]{tracker_3d_x3o1_aistat.pdf} & \hspace{-4mm} \includegraphics[width=120pt]{tracker_3d_x5o1_aistat.pdf}\\ %& \includegraphics[width=160pt]{tracker_3d_x7o1_aistat.pdf} \\
(a) & (b) & (c) \\
\multicolumn{3}{c}{}
\end{tabular}
\end{center}
