...
which crucially includes \emph{definite integration w.r.t.\ piecewise 
polynomial functions}.  To aid in the efficient computation
...
As discussed previously, piecewise polynomial functions 
...
operations, including definite integration w.r.t.\ piecewise polynomial 
functions, can be computed exactly and in closed-form
