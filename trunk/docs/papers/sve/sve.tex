...
\begin{center}
\vspace{-1mm}
\includegraphics[width=.8\textwidth]{gm2.pdf}
\end{center}
\vspace{-4mm}
...
As discussed in Section~\ref{sec:intro}, piecewise polynomial functions 
provide an expressive framework for representing discrete/continuous
variable graphical models when all distributions have bounded
support.  In this section, we introduce 
a case notation and operations for piecewise polynomials, define factor
graphs in terms of these case statements, and finally show that all VE
operations, including definite integration w.r.t.\ nonlinear piecewise
boundary constraints, can be computed exactly and in closed-form
using a purely \emph{symbolic} representation, hence the algorithm
\emph{Symbolic VE} (SVE).
...
\begin{center}
\vspace{-1mm}
\includegraphics[width=.25\textwidth]{norm_unif.pdf}
\end{center}
\vspace{-2mm}
...
\begin{tabular}{ccc}
\vspace{-3mm}
\hspace{-8mm} \includegraphics[width=120pt]{r1.pdf} & \hspace{-6mm} \includegraphics[width=120pt]{r2.pdf} & \hspace{-10mm} \includegraphics[width=120pt]{r3.pdf} \\  
\vspace{4mm}
{\small$\E[D|x_1=6, x_2=5] = 4.98$} & {\small$\E[D|x_1=8, x_2=5]= 6.0$} & \hspace{-3mm} {\small$\E[D|x_1=5, x_2=3, x_3=8] = 4.39$}\\
\vspace{-2mm}
\hspace{-8mm} \includegraphics[width=120pt]{r4.pdf} & \hspace{-6mm} \includegraphics[width=120pt]{r5.pdf} & \hspace{-10mm} \includegraphics[width=120pt]{r6.pdf} \\
\vspace{4mm}
{\small$\E[D|x_1=5, x_2=5, x_3=6] = 4.98$} & {\small$\E[D|x_2=1, x_2=3, x_3=4, x_4=8] = 5.45$} & {\small$\E[D|x_1=5, x_2=4, x_3=6, x_4=5] = 4.89$} 
\end{tabular}
\end{center}
\vspace{-6mm}
...
\begin{center}
\vspace{-1mm}
\includegraphics[width=1.0\textwidth]{gm3.pdf}
\end{center}
\vspace{-5mm}
