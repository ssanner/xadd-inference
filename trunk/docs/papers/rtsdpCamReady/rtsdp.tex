...
\begin{figure*}[!ht]
\subfloat[RTSDP - $V^1$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-Value1.pdf}
\label{invent2rtdp_plot1}}
\subfloat[RTSDP - $DD^1$ - 7 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-DD1.pdf}
\label{invent2rtdp_dd1}} 
\hspace{0.1cm}
\subfloat[SDP - $V^1$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-Value1.pdf}
\label{invent2sdp_plot1}}
\subfloat[SDP - $DD^1$ - 7 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-DD1.pdf}
\label{invent2sdp_dd1}} 

\subfloat[RTSDP - $V^2$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-Value2.pdf}
\label{invent2rtdp_plot2}}
\subfloat[RTSDP - $DD^2$ - 22 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-DD2.pdf}
\label{invent2rtdp_dd2}} 
\hspace{0.1cm}
\subfloat[SDP - $V^2$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-Value2.pdf}
\label{invent2sdp_plot2}}
\subfloat[SDP - $DD^2$ - 50 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-DD2.pdf}
\label{invent2sdp_dd2}} 

\subfloat[RTSDP - $V^3$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-Value3.pdf}
\label{invent2rtdp_plot3}}
\subfloat[RTSDP - $DD^3$ - 39 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-DD3.pdf}
\label{invent2rtdp_dd3}} 
\hspace{0.1cm}
\subfloat[SDP - $V^3$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-Value3.pdf}
\label{invent2sdp_plot3}}
\subfloat[SDP - $DD^3$ - 142 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-DD3.pdf}
\label{invent2sdp_dd3}} 

\subfloat[RTSDP - $V^4$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-Value4.pdf}
\label{invent2rtdp_plot4}}
\subfloat[RTSDP - $DD^4$ - 12 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/RTSDP-DD4.pdf}
\label{invent2rtdp_dd4}} 
\hspace{0.1cm}
\subfloat[SDP - $V^4$]{\includegraphics[width=0.26\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-Value4.pdf}
\label{invent2sdp_plot4}}
\subfloat[SDP - $DD^4$ - 272 Nodes]{\includegraphics[width=0.22\linewidth, height=0.16\linewidth]{figures/\solutionExample/SDP-DD4.pdf}
...
%Solution convergency gency can be and anytime solution quality are likely to be obtained with the labelling~\cite{Bonet03LRTDP} and online~\cite{kolobov12GOURMAND} modifications. Also, a very important factor to improve performance that should be explored is to use more informative heuristics that can greatly reduce the number of relevant regions. 
...
% with a visited-state based pruning
