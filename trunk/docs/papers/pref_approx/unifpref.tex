...
Figure~\ref{fig:polytope}. The objective of preference learning as in Equation \ref Details of how integration is performed in such cases are presented in \cite{sve11}. However, integration 
