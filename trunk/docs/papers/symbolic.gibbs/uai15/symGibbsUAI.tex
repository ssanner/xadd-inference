...
They are polynomial fractions with polynomial partitioning constraints
...
Our novel sampling method, \emph{symbolic Gibbs}, saves a significant amount of computation, and improves the performance dramatically. The combination of these novel contributions should make probabilistic reasoning applicable to variety of new applications that have remained unsolvable so far. 
