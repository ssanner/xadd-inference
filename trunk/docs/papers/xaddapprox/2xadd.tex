...
Figure~\ref{fig:symbex}(a) shows the plot of a piecewise function and
Figure~\ref{fig:symbex}(b) its XADD representation.  Underlying the
XADD in Figure~\ref{fig:symbex}(b) is a simple piecewise linear
...
In the XADD examples of Figure~\ref{fig:stepfunfig},  
...
$\theta_{ij}$. Figure~\ref{fig:symbex}(a) illustrates the different
polytopes in the XADD of \ref{fig:symbex}(b).
