...
\begin{minipage}{.3\textwidth}
  ...
  \subfigure[Step function] {
	\fbox{\includegraphics[scale=0.5]{Figures/step.png}}
	\label{stepf}
  }
\end{minipage}
\begin{minipage}{.3\textwidth}
...
\subfigure[Linear Approximation] {
	 \fbox{\includegraphics[scale=0.5]{Figures/steplin.png}}
	\label{steptolin} 
}
\end{minipage}
...
\begin{minipage}{.3\textwidth}
  \centering
  \subfigure[Original] {
	\fbox{\includegraphics[scale=0.4]{Figures/step1.png}}
	\label{step1}
  }
\end{minipage}
\begin{minipage}{.3\textwidth}
\centering
\subfigure[Step1] {
	 \fbox{\includegraphics[scale=0.4]{Figures/step12.png}}
	\label{step2} 
}
\end{minipage}
\begin{minipage}{.3\textwidth}
\centering
\subfigure[Step2]{
	 \fbox{\includegraphics[scale=0.4]{Figures/step123.png}}
	 \label{step2}
}
\end{minipage}
