...
\begin{abstract}
%TODO: emphasize solution is exact, optimal according to adversarial
%semantics as used in robust optimization.  First results for hybrid
%systems with piecewise linear dynamics and state-dependent noise ---
%something that is typically not handled in control theory, much less
%with these expressive dynamics. Reference to chance constraints?
...
\section{Robust Hybrid MDPs} %Continuous State and Action MDPs}
