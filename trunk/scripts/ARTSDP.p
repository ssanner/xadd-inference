...
set style line 1 lc rgb '#00FFFF' pt 1 ps 1 lt 1 lw 2 # --- cyan
set style line 2 lc rgb '#2020C0' pt 8 ps 1 lt 1 lw 2 # --- blue
set style line 3 lc rgb '#C02020' pt 1 ps 1 lt 1 lw 2 # --- red
set style line 4 lc rgb '#20C020' pt 4 ps 1 lt 1 lw 2 # --- green
set style line 5 lc rgb '#B0B040' pt 2 ps 1 lt 1 lw 2 # --- yellow
...
print "GNUPLOT ARTSDP.p COMPLETE"