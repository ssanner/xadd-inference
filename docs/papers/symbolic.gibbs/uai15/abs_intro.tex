...
evaluate this novel Symbolic Gibbs algorithm on models motivated by physics and engineering
and show that it is an order of magnitude faster than alternative
