...
In the first experimental model (Section~\ref{sect:model1})
...
since the the performance of Rej drastically deteriorates in dimensionality.
...
which enables us to compute the ground truth manually.% rather than relying on Rej.
