...
inference in such graphical models has been restricted to piecewise
polynomial/exponential factors with hyperrectangular, hyper-rhombus
or linear partitioning 
constraints~\cite{shenoy2011inference,shenoy2012two,Sanner:12} and
existing work has altogether ignored issues of nonlinear determinism.
...
sampling.  We evaluate this fully automated Symbolic Gibbs sampler for
...
tractability and accuracy boundaries of existing inference methods.
...
% TODO: The following needs to be argued for more clearly above before
%       it can be included here.  -Scott
%
% and even for linear constraints, the existing works are too restrictive.

% TODO: What happened to a general introduction to graphical model
%       notation and a description of deterministic constraints in
%       graphical models before you dive into details of collapsing???
%       -Scott
