...
In this section, we are interested in (a) comparing the efficiency and accuracy of our proposed Symbolic Gibbs against other MCMC methods on graphical models with piecewise factors and observed determinism, as well as 
...
In this paper we introduced an expressive class of graphical
models with nonlinear determinism where piecewise factors 
based on a rich class of polynomial piecewise
