...
%and Anglican implementation of \emph{Sequential Monte Carlo} (SMC) %using Anglican probabilistic programming language \cite{wood2014new}.
%SymGibbs and BaseGibbs require no tunings. MH is automatically tuned after \cite{roberts1997weak} by testing 200 equidistant proposal variances in interval $(0, 0.1]$ and accepting a variance for which the acceptance rate closer to 0.24.
...
(2) %Particularly in high dimensional models, 
