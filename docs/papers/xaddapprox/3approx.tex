...
%%
%% NOTE: the example should really demonstrate the merge error accumulating.
%%
\label{alg:approx}
\end{algorithm}
\decmargin{1.5em}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                Scott stopped editing here for now
%%
%% Need to explain intuitively this in the context of Figure 4,
%% then step through the simplification of the problem.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
