...
%% worth discussion complications of only $<,>$ at this point in
...
%inequalities in $\phi_i$ are linear. In this case, we note that any
%logical formula can be rewritten as a disjunction of conjunctive
