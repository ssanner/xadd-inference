...
\begin{subfigure}{.48\textwidth}
  \centering
  \includegraphics[scale=0.6]{plot/bppl_data_analysis_fit.pdf}
  \caption{}
...
\begin{subfigure}{.48\textwidth}
  \centering
  \hspace{5mm} 
  \includegraphics[scale=0.6]{plot/bppl_dim_analysis_fit.pdf}
  \caption{}
  \label{fig:error-samples-bppl}
\end{subfigure}
...
\begin{subfigure}{.48\textwidth}
  \centering
  \includegraphics[scale=0.6]{plot/mmm_data_analysis2.pdf}
  \caption{}
  \label{fig:mmm_data_analysis}
\end{subfigure}
\begin{subfigure}{.48\textwidth}
  \centering
  \hspace{5mm} \includegraphics[scale=0.6]{plot/mmm_dim_analysis10.pdf}
  \caption{}
