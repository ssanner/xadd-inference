...
\item Priming $V^0$ which %the current state variables ($d_i,l_j$) to build the next states ($d_i',l_j'$) in the value function. This
...
%for which no general robust closed-form solutions previously existed.
...
%substantially increasing the scalability of our
%approach in exchange for restricting solution optimality to a known
