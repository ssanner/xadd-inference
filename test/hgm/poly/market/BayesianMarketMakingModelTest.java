...
//        instance.testPriorMaking();
    ...
    public void basicTest() throws FileNotFoundException {
        ...
        BayesianMarketMakingModel learning = new BayesianMarketMakingModel(
                BayesianMarketMakingModel.uniformInEllipse(30, 10),
                        //.uniformInHypercube(20)
                        testDB1, 8.001, "v");

        // Pr(W | R^{n+1})
        BayesianPosteriorHandler posterior = learning.computeBayesianPosterior();
...
//        GatedGibbsPolytopesSampler.DEBUG = false;
    ...
    public void testOnDummyDb() {
        double c = 20;
        double epsilon = 1.5d;
        MarketMakingDatabase db = new DummyMarketMakingDatabase(2, 20, 15, epsilon);
        BayesianMarketMakingModel learning = new BayesianMarketMakingModel(
...
//            double r = 3;
            ...
            public double evaluate(VarAssignment fullVarAssign) {
                ...
                if (f(x,y)<0) return 1.0; else return 0.0;
